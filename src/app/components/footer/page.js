        ...
        <div className="footer-container">
          ...
          <div className="footer-column">
            ...
            <div className="footer-icons">
              ...
              <Link href="https://www.instagram.com/hubhawks_in/">
                <span className="footer-contact-icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
              ...
              <Link href="https://www.facebook.com/hubhawks/">
                <span className="footer-contact-icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
              ...
              <Link href="https://www.linkedin.com/company/hubhawks?originalSubdomain=in">
                <span className="footer-contact-icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
