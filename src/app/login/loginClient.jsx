...
//   const redirectPath = "/components/gigsPage"; // <- updated redirect path

//   useEffect(() => {
//     if (hasMounted && !loading && user) {
//       router.replace(redirectPath); // Redirect if already logged in
//     }
//   }, [hasMounted, user, loading, router]);
...
//     try {
//       await signInWithEmailAndPassword(auth, email, password);
//       router.push(redirectPath); // <- updated redirect path
//     } catch (err) {
//       if (err.code === "auth/user-not-found") {
//         setError("⚠️ User not found. Please sign up first.");
//       } else if (err.code === "auth/wrong-password") {
